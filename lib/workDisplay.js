    ...
    var html = '',
        ...
        projects = [
...

          {
            ...
            about: "Large global campaign spanning multiple countries and using multiple languages. Site was deployed to many different sites, including the front of Levis.com in multiple counties, including the U.S.",
    ...
    html = "                                                            \
      <div>                                                             \
        <a href=/recent_work/" + (projects[id - 1] || 
                                  ...
                                  ">< " +
          (projects[id - 1] || projects[projects.length - 1]).title +
          "</a>                                                         \
        <a href=/recent_work/" + (projects[id + 1] || projects[0]).short + ">" +
          (projects[id + 1] || projects[0]).title + "></a>            \
      </div>                                                            \
                                                                        \
